...
char *create_command(char *, struct queue *);
char **create_env(struct queue *);
...
int disp_env(struct shell_info *);
void exec_command(struct shell_info *);
void check_signal(int);
void destroy_shell(struct shell_info *);
void change_path(struct shell_info *);
void my_pustr_err(char *);
